...
class UtilisateurFrontOfficeApiController extends Controller
{
    ...
    public function utilisateur($id_utilisateur)
    {
        try {
            ...
            return response()->json(['message' => 'Erreur lors de la récupération d utilisateur'], 400);
        }
    }
    ...
    public function modifierProfil(Request $request)
    {
        try {
            ...
            return response()->json(['message' => 'Erreur lors de la modification de profil'], 400);
        }
    }
}
